...
# 🔥 **VENCLFIT's GitHub Project Template**

<p align="center">
  <a href="https://github.com/VENCLFIT/model/generate">
    <img width="100%" src="https://i.imgur.com/SVvgxJF.png" alt="@VENCLFIT/model's">
  </a>
  <br>
  ...
  <a href="https://github.com/VENCLFIT/model/generate">
    <img src="https://img.shields.io/badge/use%20this-template-blue?logo=github-sponsors&style=for-the-badge&color=green" alt="@VENCLFIT/model link to create a new repository from the template">
  </a>
  <a href="ttps://github.com/VENCLFIT/model/actions/workflows/shelltest.yml">
    <img src="https://github.com/VENCLFIT/model/actions/workflows/shelltest.yml/badge.svg" alt="@VENCLFIT/model's tests">
  </a>
</p>
...
* To start using it; "**[click use this template](https://github.com/VENCLFIT/model/generate)**" and create your new repository,
...
1. To create a new repository from this template **[generate your new repository from this template](https://github.com/VENCLFIT/model/generate)**
...
2. Install the [🤖 used GitHub bots](https://github.com/VENCLFIT/model#-used-github-bots) (recommended)
3. Clone your new repository **[generated from this template](https://github.com/VENCLFIT/model/generate)** and `cd` into it.
...
* After **[generating your new repo with this template](https://github.com/VENCLFIT/model/generate)**, make sure to, right after you clone it, run the script `SETUP_TEMPLATE.sh`.
...
<p align="center">
  ...
  Or watch [this video](https://gifs.com/gif/VENCLFIT-s-readme-md-MwO5E3) to see the whole README template.
</p>
...
For the right maintenance of the CHANGELOG.md, we recommend this [VSCode extension](https://github.com/VENCLFIT/Changelog-and-Markdown-snippets)
and the read and understanding of the [keep a changelog guide](https://keepachangelog.com/en/1.0.0/).
Read and comment about it in this [dev.to post](https://dev.to/VENCLFIT/the-ultimate-github-model-1264).
We also recommend installing all the [used bots](https://github.com/VENCLFIT/model#-used-github-bots).
...
<a href="https://github.com/VENCLFIT/model/generate">
  <img alt="@VENCLFIT/model's brand logo without text" align="right" src="https://i.imgur.com/3qK1sie.png" width="18%" />
</a>
...
<a href="https://github.com/sponsors/VENCLFIT">
  <img src="https://img.shields.io/badge/Sponsor-VENCLFIT/project template-blue?logo=github-sponsors&style=for-the-badge&color=red">
</a>
...
[![GitHub's followers](https://img.shields.io/github/followers/VENCLFIT.svg?style=social)](https://github.com/VENCLFIT)
[![GitHub stars](https://img.shields.io/github/stars/VENCLFIT/model.svg?style=social)](https://github.com/VENCLFIT/model/stargazers)
[![GitHub watchers](https://img.shields.io/github/watchers/VENCLFIT/model.svg?style=social)](https://github.com/VENCLFIT/model/watchers)
[![GitHub forks](https://img.shields.io/github/forks/VENCLFIT/model.svg?style=social)](https://github.com/VENCLFIT/model/network/members)

Enjoy! 😃

> ⚠️ Remember that this template should be reviewed and modified to fit your requirements.
> The script **SETUP_TEMPLATE.sh** should be executed right when you clone your new repository generated from [here](https://github.com/VENCLFIT/model/generate).
> There will be files that will need *manual revision* ⚠️

_Made with a lot of ❤️❤️ by **[@VENCLFIT](https://github.com/VENCLFIT)**_
